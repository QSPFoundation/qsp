...
long qspReCodeGetIntVal(QSP_CHAR *val)
{
	long num;
...
long qspCodeWriteIntVal(QSP_CHAR **s, long len, long val, QSP_BOOL isCode)
{
...
long qspCodeWriteVal(QSP_CHAR **s, long len, QSP_CHAR *val, QSP_BOOL isCode)
{
	QSP_CHAR *temp;
	if (val)
	{
