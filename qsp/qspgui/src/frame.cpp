...
BEGIN_EVENT_TABLE(QSPFrame, wxFrame)
	...
	EVT_KEY(ID_MAINDESC, QSPFrame::OnKey)
	EVT_KEY(ID_VARSDESC, QSPFrame::OnKey)
	EVT_KEY(ID_ACTIONS, QSPFrame::OnKey)
	EVT_KEY(ID_OBJECTS, QSPFrame::OnKey)
	EVT_KEY(ID_VIEWPIC, QSPFrame::OnKey)
	EVT_KEY(ID_BACKPIC, QSPFrame::OnKey)
	EVT_MOUSEWHEEL(QSPFrame::OnWheel)
	EVT_WHEEL(ID_MAINDESC, QSPFrame::OnWheel)
	EVT_WHEEL(ID_VARSDESC, QSPFrame::OnWheel)
	EVT_WHEEL(ID_ACTIONS, QSPFrame::OnWheel)
	EVT_WHEEL(ID_OBJECTS, QSPFrame::OnWheel)
	EVT_WHEEL(ID_VIEWPIC, QSPFrame::OnWheel)
	EVT_WHEEL(ID_BACKPIC, QSPFrame::OnWheel)
	EVT_WHEEL(ID_INPUT, QSPFrame::OnWheel)
