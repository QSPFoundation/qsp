...
QSPString qspGetErrorDesc(int errorNum)
{
    ...
    switch (errorNum)
    {
    case QSP_ERR_INTERNAL: str = QSP_STATIC_STR(QSP_FMT("Internal error!")); break;
    ...
    case QSP_ERR_LOCCALLDEPTH: str = QSP_STATIC_STR(QSP_FMT("Maximum location call depth exceeded!")); break;
    case QSP_ERR_COMPLEXEXPRESSION: str = QSP_STATIC_STR(QSP_FMT("Expression too complex!")); break;
    ...
    case QSP_ERR_COLONNOTFOUND: str = QSP_STATIC_STR(QSP_FMT("Token [:] not found!")); break;
    case QSP_ERR_ENDNOTFOUND: str = QSP_STATIC_STR(QSP_FMT("Token [end] not found!")); break;
    case QSP_ERR_CANTINCFILE: str = QSP_STATIC_STR(QSP_FMT("Can't include file!")); break;
    ...
    case QSP_ERR_BRACKETNOTFOUND: str = QSP_STATIC_STR(QSP_FMT("Bracket not found!")); break;
